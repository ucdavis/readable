...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("server.core.Domain.ExternalApiRateLimitBucket", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("PausedUntilUtc")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset>("UpdatedAtUtc")
                        .HasColumnType("datetimeoffset");

                    b.HasKey("Provider", "Operation", "BucketKey");

                    b.HasIndex("PausedUntilUtc");

                    b.ToTable("ExternalApiRateLimitBuckets", (string)null);
                });

            modelBuilder.Entity("server.core.Domain.ExternalApiRateLimitReservation", b =>
                {
                    ...
                    b.HasIndex("Provider", "Operation", "BucketKey", "ExpiresAtUtc");

                    b.ToTable("ExternalApiRateLimitReservations", null, t =>
                        {
                            t.HasCheckConstraint("CK_ExternalApiRateLimitReservations_Cost", "[Cost] > 0");
                        });
                });
